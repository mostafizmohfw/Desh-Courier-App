            ...
            <div class="flex flex-col h-full justify-between">
                <div class="pr-4">
                    <div>
                        ...
                        <ul class="ml-2">
                            <li class="mb-3">
                                <a href="{{ route('admin.dashboard') }}" class="flex text-gray-300 items-center gap-2">
                            ...
                            <li class="mb-3">
                                <a href="{{ route('shipment') }}" class="flex text-blue-600 font-bold items-center gap-2">
                            ...
                            <li class="mb-3">
                                <a href="{{ route('payment') }}" class="flex text-gray-300 items-center gap-2">
                            ...
                            <li class="mb-3">
                                <a href="{{ route('location') }}" class="flex text-gray-300 items-center gap-2">
                    ...
                    <div>
                        ...
                        <ul class="ml-2">
                            <li class="mb-3">
                                <a href="{{ route('employee') }}" class="flex text-gray-300 items-center gap-2">
