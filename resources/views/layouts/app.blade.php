    ...
    <div class="pl-4 flex">
        ...
        <div class="w-1/6 border-r dc-header-broder-color pt-8">
            <div class="flex flex-col h-full justify-between">
                <div class="pr-4">
                    <div>
                        ...
                        <ul class="ml-2">
                            ...
                            <li class="mb-3">
                                <x-responsive-nav-link :href="route('shipment')" :active="request()->routeIs('shipment')" class="flex text-gray-300 items-center gap-2">
                            ...
                            <li class="mb-3">
                                <x-responsive-nav-link :href="route('payment')" :active="request()->routeIs('payment')" class="flex text-gray-300 items-center gap-2">
                ...
                <div class="">
                    <div class=" pr-4 pb-6">
                        <x-responsive-nav-link :href="route('settings')" :active="request()->routeIs('settings')" class="bg-[#F9F9F9] p-4 flex gap-4 mb-2.5">
                            <img src="{{ asset('assets/img/Iconly/Light/setting.svg') }}" alt="">
                            Settings
                        </x-responsive-nav-link>
                        <x-responsive-nav-link :href="route('logout')" :active="request()->routeIs('logout')" class="bg-[#F9F9F9] p-4 flex gap-4">
